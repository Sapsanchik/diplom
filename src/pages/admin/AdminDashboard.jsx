    ...
    <Layout>
      <div>
        <div className="top mb-5 px-5 mt-5">
          <div className=" bg-gray-50 py-5 border border-blue-gray-600 rounded-lg">
            <h1 className=" text-center text-2xl font-bold text-blue-gray-500">
          ...
          <div className="mid mb-5">
            <div className=" bg-gray-50 py-5 rounded-xl border border-gray-100">
              <div className="flex justify-center">
                <img
                  src="https://cdn-icons-png.flaticon.com/128/2489/2489601.png"
                  alt=""
                />
              </div>
              ...
              <TabList className="flex flex-wrap -m-4 text-center justify-center">
                <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                  <div className=" border bg-gray-50 hover:bg-gray-100 border-gray-100 px-4 py-3 rounded-xl">
                    ...
                    <p className=" text-gray-500  font-bold">Количество товаров</p>
                  </div>
                </Tab>
                ...
                <Tab className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                  <div className=" border bg-gray-50 hover:bg-gray-100 border-gray-100 px-4 py-3 rounded-xl">
                    ...
                    <p className=" text-gray-500  font-bold">Количество покупок</p>
                  </div>
                </Tab>
                ...
                <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                  <div className=" border bg-gray-50 hover:bg-gray-100 border-gray-100 px-4 py-3 rounded-xl">
                    ...
                    <p className=" text-gray-700  font-bold">Количество пользователей</p>
                  </div>
                </Tab>
              </TabList>
